...
export default {
  mounted: function () {
    (function () {
      ...
      // var minimumColor = '#99ff99'
      // var maximumColor = '#ff8080'
      /*
    var colorScale = d3.scaleLinear()
      ...
      d3.queue()
        .defer(d3.csv, 'static/data/sidi_ifni.csv')/*
      .defer(d3.csv, 'static/data/communes.csv', function (d) {
      ...
      // eslint-disable-next-line handle-callback-err
        .await(function (error, data) {
          ...
          color.domain([1, 10])
          d3.queue()
            .defer(d3.json, 'static/data/sidi_ifni.json')
            // eslint-disable-next-line handle-callback-err
